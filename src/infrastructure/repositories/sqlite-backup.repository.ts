        ...
        tx.insert(tabelaProduto)
          ...
          .onConflictDoUpdate({
            ...
            set: {
              ...
              fatorConversaoEmbalagem: linha.fatorConversaoEmbalagem,
              valorReferenciaEmbalagem: linha.valorReferenciaEmbalagem,
              ativo: linha.ativo,
              criadoEm: linha.criadoEm,
              atualizadoEm: linha.atualizadoEm,
        ...
        tx.insert(tabelaCompraItem)
          ...
          .onConflictDoUpdate({
            ...
            set: {
              ...
              fatorUsadoNaCompra: item.fatorUsadoNaCompra,
