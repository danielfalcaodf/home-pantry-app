...
|---|---|---|---|---|
| 1 | `bootstrap-projeto-expo` | ⬜ | Projeto Expo + Expo Router + development build EAS + camadas + lint de fronteira + `Result` + UUID v7 | Não existe `package.json`. Bloqueia tudo. |
