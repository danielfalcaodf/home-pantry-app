...
Permitir que o usuário reverta um registro de consumo recente sem navegar para fora do fluxo, com uma janela de tempo curta e visível, mantendo o movimento original intacto (append-only).
