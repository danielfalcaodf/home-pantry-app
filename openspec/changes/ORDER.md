...
| 6 | correcao-tela-editar-produto | — | **Reaberta em 2026-08-21**: E2E não rodado, e o próprio `design.md` registrava "regressão visual não detectável sem Maestro" como risco aceito. 5 cenários em `.maestro/bug-editar-produto-*.yaml`. | Unitário/RNTL verde; E2E **pendente** (tasks.md §5). |
