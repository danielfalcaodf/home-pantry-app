...
|---|---|---|---|
| 07 | configuracoes-e-backup | — (`alvos-de-toque-e-acessibilidade` arquivada em 2026-08-13) | Link p/ Diagnóstico pós-restauração (039) + cobertura (038, 040); `configuracoes.tsx` também é tocada por 06 (059, 060) |
...
| 11 | cobertura-telas-e-navegacao | 07 (`correcao-autofoco-detalhe-produto` arquivada em 2026-08-09; `botao-voltar-conferencia` arquivada em 2026-08-13; `alvos-de-toque-e-acessibilidade` arquivada em 2026-08-13) | Testes de telas/navegação (041, 042, 045, 048, 049, 051, 052) devem asserir o estado pós-correções |
