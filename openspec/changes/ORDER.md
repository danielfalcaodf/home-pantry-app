...
|---|---|---|---|
| 01 | correcao-fuso-horario-testes | — | Desbloqueia o gate `npm test` (2 testes falham por TZ) antes de qualquer outra change rodar o fluxo de testes |
| 02 | correcao-autofoco-detalhe-produto | 01 | Bug crítico do KPI K4 (ACHADO-056); depende de 01 só pelo gate de testes verde |
| 03 | botao-voltar-conferencia | 01 | Bug crítico de navegação (ACHADO-062, 055); mesma tela `app/conferencia.tsx` |
| 04 | correcao-chips-de-estado | 01 | Bug crítico de divergência do chip "Faltando" (ACHADO-053, 017, 050); toca `chip-estado.tsx` e `resumo.tsx` |
| 05 | correcao-fluxo-modo-compra | 01 | Bugs médios do modo compra (ACHADO-034, 054) + cobertura da mesma tela (035, 036, 037) |
...
| 08 | cobertura-banco-e-migrations | 01 | Dívida de teste de infra/db (004, 005, 011-014, 044); independe da UI |
