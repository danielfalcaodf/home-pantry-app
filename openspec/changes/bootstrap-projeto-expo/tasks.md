...
- [ ] 1.1 Inicializar projeto Expo com template TypeScript + Expo Router na raiz do repositório, preservando os `.md` de design, o `LICENSE`, o `README.md` e a pasta `openspec/`
