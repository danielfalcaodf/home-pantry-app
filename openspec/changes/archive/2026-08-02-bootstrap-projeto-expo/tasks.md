...
- [x] 2.2 Criar os diretórios de rota `app/(tabs)/`, `app/produto/` e `app/compra/` com placeholders que renderizam um texto, só para validar o roteamento
...
- [x] 3.4 Rodar o verificador de dependências do Expo e resolver qualquer incompatibilidade de versão apontada
...
- [x] 7.2 Configurar `eslint-plugin-boundaries` declarando as camadas `domain`, `ports`, `application`, `infrastructure`, `presentation` e as regras de import permitidas entre elas
...
- [x] 8.3 Atualizar o `README.md` com como rodar o projeto pelo development build, deixando explícito que Expo Go não é suportado
