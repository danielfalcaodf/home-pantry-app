...
A tela de detalhe SHALL exibir a quantidade atual em destaque, permitir editar todos os campos do produto, e exibir no rodapé um resumo do histórico recente de registros.
...
- **WHEN** o usuário altera um campo e salva
...
- **THEN** o item passa a aparecer como faltando na despensa
