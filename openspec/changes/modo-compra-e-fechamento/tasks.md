...
- [ ] 1.2 Criar `src/application/compra/use-iniciar-compra.ts` materializando os itens correntes da lista como itens planejados da compra aberta
- [ ] 1.3 Registrar a quantidade planejada **exatamente** como exibida na lista, sem reaplicar o arredondamento
- [ ] 1.4 Registrar o valor estimado por unidade em cada item materializado
- [ ] 1.5 Não duplicar os itens avulsos, que já pertencem à compra aberta
